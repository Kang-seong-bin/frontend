function valid_check() {
    ...
    //실제 이메일 주소는 형식이 위의 조건보다 복잡합니다. 계정문자열에 특수기호는 -,_,.만 들어갈 수 있습니다.
    //               도메인이름에 숫자와 기호 사용못합니다. naver.com O / na-ver.com X  /333naver.com X (숫자로 시작하면 안된다!)
    //복잡한 조건의 유효성검사를 정규식표현으로 할 수 있습니다.
    //정규표현식은 전화번호,이메일,패스워드, 한글, 영문 입력체크에 활용.
    var regEmail = /^[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_\.]?[0-9a-zA-Z])*\.[a-zA-Z]{2,3}$/;//정확한 문자 @ \. 지정
                    //        ?앞의 중괄호는 나올 수도 있다 그후 조건과 정확히 나와야하는 @지정, .지정을 위해 \사용               
...
//함수결과값 === true (함수결과 값 string "true" 일 때는 거짓 )
